...
#[derive(Debug, Deserialize, Clone)]
pub struct ChainstreakConfig {
    pub enabled: bool,
}

#[derive(Debug, Deserialize, Clone)]
pub struct ChainsgreetsConfig {
    pub enabled: bool,
}
...
impl Config {
    ...
    pub fn flowonarc_enabled(&self) -> bool {
    ...
    pub fn painitiepay_enabled(&self) -> bool {
    ...
    pub fn chainstreak_enabled(&self) -> bool {
        self.chainstreak.as_ref().map(|c| c.enabled).unwrap_or(false)
    }

    pub fn chainsgreets_enabled(&self) -> bool {
